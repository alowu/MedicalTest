...
namespace Model
{
	public class PatientRepository : IRepository<Patient>
	{
		...
		public bool Create(Patient item)
		{
			...
			try
			{
				sqlCommand = new SqlCommand("INSERT INTO [Patients] (firstName, middleName, lastName, age, sex, hasExam) VALUES (@firstName, @middleName, @lastName, @age, @sex, @hasExam)", DB._getConnection());
		...
		public Patient GetT(int Id)
		{
			Patient patient = null;

			string command = "SELECT * FROM [Patients] WHERE id=";
			command += Id;
			...
			{
				Console.Error.WriteLine("Can't GET_T Patients!\n" + ex.ToString());
			}
			finally
			{
				if (dataReader != null)
